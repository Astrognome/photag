...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.thumbnail_list = QtWidgets.QListWidget(self.tag_tree_holder)
        self.thumbnail_list.setIconSize(QtCore.QSize(100, 100))
        self.thumbnail_list.setGridSize(QtCore.QSize(100, 120))
        self.thumbnail_list.setViewMode(QtWidgets.QListView.IconMode)
        self.thumbnail_list.setObjectName("thumbnail_list")
        self.verticalLayout_3.addWidget(self.thumbnail_list)
